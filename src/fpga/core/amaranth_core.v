...
, cont1_joy, cont2_joy, cont3_joy, cont4_joy, cont1_trig, cont2_trig, cont3_trig, cont4_trig, clk);
...
module \amaranth_core.video_clk_div (rst, \clk$1 , clk90, stb, clk);
  ...
  output clk90;
  wire clk90;
  reg [59:0] clk_reg = 60'h7ffffffe0000000;
  ...
  always @(posedge clk, posedge rst)
    if (rst) clk_reg <= 60'h7ffffffe0000000;
  ...
  always @* begin
    ...
    casez (rst)
      1'h1:
          \clk_reg$next  = 60'h7ffffffe0000000;
    endcase
  end
  always @* begin
    if (\$auto$verilog_backend.cc:2189:dump_module$2 ) begin end
