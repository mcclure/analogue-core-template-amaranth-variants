/* Generated by Yosys 0.26+50 (git sha1 ef8ed21a2, ccache clang 11.0.1-2 -O0 -fPIC) */
...
, user2, video_de, video_hs, video_rgb, video_rgb_clk, video_rgb_clk90, video_skip, video_vs, audio_adc);
  ...
  assign \$20  = x_count == 10'h270;
  assign \$22  = x_count == 10'h270;
  assign \$25  = y_count + 1'h1;
  assign \$27  = y_count == 9'h1ee;
  assign \$29  = x_count >= 4'ha;
  assign \$31  = x_count < 10'h262;
  assign \$33  = \$29  & \$31 ;
  assign \$35  = y_count >= 4'ha;
  assign \$37  = y_count < 9'h1ea;
  assign \$3  = ~ video_rgb_clk;
  assign \$39  = \$35  & \$37 ;
  assign \$41  = x_count >= 4'ha;
  assign \$43  = x_count < 10'h262;
  assign \$45  = \$41  & \$43 ;
  assign \$47  = y_count >= 4'ha;
  assign \$49  = y_count < 9'h1ea;
  assign \$51  = \$47  & \$49 ;
